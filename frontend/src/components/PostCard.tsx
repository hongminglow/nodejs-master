...
export default function PostCard({
	...
	const formattedDate = new Date(Number(createdAt)).toLocaleDateString("en-US", {
		month: "short",
		day: "numeric",
		year: "numeric",
	});
	...
	return (
		<article
			onClick={onClick}
			className="glass-card rounded-2xl p-6 transition-all duration-300 hover:bg-surface-800/60 hover:border-brand-500/20 hover:shadow-lg hover:shadow-brand-500/5 cursor-pointer group"
		>
			{/* Header */}
			...
			{/* Content preview */}
			<p className="text-sm text-surface-400 leading-relaxed line-clamp-3 mb-4">{content}</p>
